        ...
        <form className="space-y-4" ref={formRef}>
          ...
          {success && (
            <div className="mt-2 text-sm italic text-gray-500">
              ...
              and if a slot is open, you'll receive an email with the next steps and you'll gain
              access to the app on October 11th. We appreciate your patience and look forward to
              having you onboard!{' '}
            </div>
          )}
        </form>
